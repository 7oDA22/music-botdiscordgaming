...
client.on('ready', () => {
   console.log(`----------------`);
      console.log(`Desert Bot- Script By :Mahmoud-QuaStyle`);
        console.log(`----------------`);
      console.log(`ON ${client.guilds.size} Servers '     Script By :Mahmoud-QuaStyle ' `);
    console.log(`----------------`);
  console.log(`Logged in as ${client.user.tag}!`);
client.user.setGame(`g!bc  `,"https://discordapp.com/channels/479519956208320512/487407595590516747")
